...
export type ChartGroupId = 'market-analysis' | 'coherent-opportunity' | 'customer-intelligence-propositions'
...
export const CHART_GROUPS: ChartGroup[] = [
  ...
  {
    id: 'customer-intelligence-propositions',
    label: 'Customer Intelligence',
    description: 'Customer intelligence propositions database',
    charts: ['ci-propositions'],
    icon: '👥'
  }
]
